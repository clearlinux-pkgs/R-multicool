...
popd
pushd ..
cp -a multicool buildavx512
popd
pushd ..
cp -a multicool buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740096300
...
/V4/usr/lib64/R/library/multicool/libs/multicool.so
/VA/usr/lib64/R/library/multicool/libs/multicool.so
