...
export LANG=C
export SOURCE_DATE_EPOCH=1530489813
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library multicool|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/multicool/libs/symbols.rds
